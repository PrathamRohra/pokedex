...
export default function Home() {
  ...
  const shouldFetchMore = () => {
    ...
    return isNearBottom && pokemonList.length < 100; //Fetch only near about 100 pokemons.
  };
  ...
  const filterPokemonByType = () => {
    const filteredByType = selectedType
      ...
      : [];
    setFilteredPokemonList(filteredByType);
  };
  ...
  return (
    <div>
      ...
      <div className="flex flex-row flex-wrap items-center justify-center">
        ...
        <Filter selectedType={selectedType} onTypeChange={setSelectedType} />
      </div>
